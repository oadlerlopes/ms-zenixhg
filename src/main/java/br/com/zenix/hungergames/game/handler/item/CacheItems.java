package br.com.zenix.hungergames.game.handler.item;
...
public enum CacheItems {
	SPEC(new ItemBuilder[] { new ItemBuilder(Material.COMPASS).setName("§6Lista de Players §7(Clique para utilizar)"),
			...
			new Integer[] { 2, 6 }), 
	JOIN_ONEKIT(
					new ItemBuilder[] { new ItemBuilder(Material.CHEST).setName("§eSeletor de Kits §7(Clique para utilizar)"), new ItemBuilder(Material.ENDER_CHEST).setName("§eKit da partida §7(Clique para utilizar)") },
					new Integer[] { 0, 1 }),
	JOIN_SECKIT(
			new ItemBuilder[] { new ItemBuilder(Material.CHEST).setName("§eSeletor de Kits §7(Clique para utilizar)"), new ItemBuilder(Material.CHEST).setName("§eSeletor de Kits 2 §7(Clique para utilizar)"),  new ItemBuilder(Material.ENDER_CHEST).setName("§eKit da partida §7(Clique para utilizar)") },
			new Integer[] { 0, 1, 2 });
